    ...
    data class Response(
        ...
        data class Body(
            ...
            data class Item (
                ...
                override val bidBeginDt: String, // 입찰개시일시
                @SerializedName("bidClseDt")
                override val bidClseDt: String, // 입찰마감일시
                ...
                override val cmmnSpldmdCorpRgnLmtYn: String, // 공동수급업체지역제한여부
                ...
                override val d2bMngBssamt: String, // 방사청관리기초금액
                ...
                override val dminsttNm: String, // 수요기관명
                ...
                override val ntceInsttNm: String, // 공고기관명
                ...
                override val presmptPrce: String, // 추정가격
                ...
                override val rgstDt: String, // 등록일시
